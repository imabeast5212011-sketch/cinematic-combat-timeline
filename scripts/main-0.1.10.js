import { MODULE_ID, MODULE_TITLE } from "./constants.js?v=0.1.10";
import { loadTemplatesCompat, reportError } from "./foundry-compat.js?v=0.1.10";
import { registerSettings } from "./settings.js?v=0.1.10";
import { TimelineController } from "./timeline-controller.js?v=0.1.10";
...
Hooks.once("init", () => {
  ...
  void import("./actor-config.js?v=0.1.10")
...
Hooks.once("ready", () => {
  ...
  console.info(`${MODULE_TITLE} | Ready 0.1.10`);
});
