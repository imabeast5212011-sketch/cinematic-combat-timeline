import { MODULE_ID, MODULE_TITLE } from "./constants.js?v=0.1.12";
import { loadTemplatesCompat, reportError } from "./foundry-compat.js?v=0.1.12";
import { registerSettings } from "./settings.js?v=0.1.12";
import { TimelineController } from "./timeline-controller.js?v=0.1.12";
import { getViewedCombat } from "./combat-adapter.js?v=0.1.12";
...
Hooks.once("init", () => {
  ...
  void import("./actor-config.js?v=0.1.12")
