import { MODULE_ID, MODULE_TITLE } from "./constants.js?v=0.1.11";
import { loadTemplatesCompat, reportError } from "./foundry-compat.js?v=0.1.11";
import { registerSettings } from "./settings.js?v=0.1.11";
import { TimelineController } from "./timeline-controller.js?v=0.1.11";
import { getViewedCombat } from "./combat-adapter.js?v=0.1.11";
...
Hooks.once("init", () => {
  ...
  void import("./actor-config.js?v=0.1.11")
...
Hooks.once("ready", () => {
  ...
  console.info(`${MODULE_TITLE} | Ready 0.1.11`);
});
